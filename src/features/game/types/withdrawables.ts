...
> = {
  ...
  "Weather Hat": () => true,
  "Sakura Shirt": () => true,
  "Squirrel Onesie": () => true,
  "Locust Onesie": () => true,
  "Locust King Onesie": () => true,
  "Glacial Plume": () => true,
  "Solflare Aegis": () => true,
  "Blossom Ward": () => true,
  "Autumn's Embrace": () => true,
  "Frozen Heart": () => true,
  "Cowboy Shirt": () => true,
  "Merino Jumper": () => true,
  "Cowboy Hat": () => true,
  "Cowboy Trouser": () => true,
  "Cowboy Boots": () => true,
  "Infernal Bullwhip": () => true,
  "White Sheep Onesie": () => true,
  "Black Sheep Onesie": () => true,
  "Chicken Suit": () => true,
  "Cowgirl Skirt": () => true,
  "Dream Scarf": () => true,
  "Cowbell Necklace": () => true,
  "Milk Apron": () => true,
  "Shepherd Staff": () => true,
  "Sol & Luna": () => true,
  "Fossil Armor": () => true,
  ...
  "Pumpkin Head": () => true,
  "Gingerbread Onesie": () => true,
  "New Years Crown": () => true,
  ...
  "Oil Can": (state) => canWithdrawBoostedWearable("Oil Can", state), // Last Auction 2024/07/17
  ...
  "Love Heart Onesie": () => false,
  "Love Bear Onesie": () => false,
  ...
  "Bunny Pants": () => false,
  "Easter Apron": () => false,
  "Carrot Pitchfork": () => false,
  "Handheld Bunny": () => false,
  "Bloomwarden Suit": () => false,
  "Embersteel Suit": () => false,
  "Amberfall Suit": () => false,
  "Glacierguard Suit": () => false,
  "Broccoli Hat": () => false,
  "Frost Sword": () => false,
  "Medic Apron": () => false,
  "Obsidian Necklace": () => false,
  "Red Pepper Onesie": () => false,
  "Love Charm Shirt": () => false,
  "Sky Island Background": () => false,
  "Oracle Syringe": () => false,
  "Coin Head": () => false,

  //Festival of Colors Event Wearables
  "Paint Splattered Hair": () => false,
  "Paint Splattered Shirt": () => false,
  "Paint Splattered Overalls": () => false,
  "Paint Spray Can": () => false,
  "Slime Hat": () => false,
  "Slime Wings": () => false,
  "Slime Aura": () => false,

  //Better Together Wearables
  "Brush Back Hair": () => false,
  Moustache: () => false,
  "Chemist Potion": () => false,
  "Diamond Patterned Vest": () => false,
  "Recycle Shirt": () => false,
  "Garbage Bin Hat": () => false,
  "Turd Topper": () => false,
  "Architect Ruler": () => false,
  "Onion Leek": () => false,
  "Oil Gallon": () => false,
  "Alchemist Apron": () => false,
  "Lava Swimwear": () => false,
  "Wooly Dress": () => false,
  "Raccoon Onesie": () => false,
  "Golden Seedling": () => false,

  // Halloween 2025 Event Wearables
  "Moonseeker Potion": () => false,
  "Frizzy Bob Cut": () => false,
  "Two-toned Layered": () => false,
  "Halloween Deathscythe": () => false,
  "Moonseeker Hand Puppet": () => false,
  "Sweet Devil Horns": () => false,
  "Trick and Treat": () => false,
  "Jack O'Sweets": () => false,
  "Frank Onesie": () => false,
  "Research Uniform": () => false,
  "Sweet Devil Dress": () => false,
  "Underworld Stimpack": () => false,
  "Sweet Devil Wings": () => false,
  "Wisp Aura": () => false,
