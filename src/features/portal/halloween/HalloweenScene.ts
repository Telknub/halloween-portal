...
export class HalloweenScene extends BaseScene {
  ...
  preload() {
    ...
    this.load.spritesheet(
      "ghoul_idle",
      "world/halloween/ghoul_idle.webp",
      {
        frameWidth: 30,
        frameHeight: 32,
      },
    ...
    this.load.spritesheet(
      "ghoul_walk",
      "world/halloween/ghoul_walk.webp",
      {
        frameWidth: 30,
        frameHeight: 32,
      },
    ...
    this.load.spritesheet(
      "ghoul_attack",
      "world/halloween/ghoul_attack.webp",
      {
        frameWidth: 30,
        frameHeight: 32,
      },
    ...
    this.load.spritesheet(
      "ghoul_defeat",
      "world/halloween/ghoul_defeat.webp",
      {
        frameWidth: 30,
        frameHeight: 32,
      },
    ...
    this.load.spritesheet(
      "ghost_walk",
      "world/halloween/ghost_walk.webp",
      {
        frameWidth: 37,
        frameHeight: 40,
      },
    ...
    this.load.spritesheet(
      "ghost_idle",
      "world/halloween/ghost_idle.webp",
      {
        frameWidth: 37,
        frameHeight: 40,
      },
    ...
    this.load.spritesheet(
      "ghost_attack",
      "world/halloween/ghost_attack.webp",
      {
        frameWidth: 37,
        frameHeight: 40,
      },
    ...
    this.load.spritesheet(
      "ghost_defeat",
      "world/halloween/ghost_defeat.webp",
      {
        frameWidth: 37,
        frameHeight: 40,
      },
